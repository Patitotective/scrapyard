...
// TODO: Dejar claro que entre talleres y actividades hay tiempo para continuar trabajando en tu proyecto
const schedule = [
  { time: '7:30 AM', event: 'Se abren las puertas' },
  { time: '8:00 PM', event: 'Ceremonia de inicio' },
  { time: '8:30 PM', event: '¡Empieza a trabajar en tu proyecto!' },
  { time: '12:30 PM', event: 'Almuerzo' },
  { time: '1:00 PM', event: 'Taller #1' },
  { time: '3:00 PM', event: 'Actividad #1' },
  { time: '5:00 PM', event: 'Taller #2' },
  { time: '7:00 PM', event: 'Cena' },
  { time: '8:30 AM', event: '¡Presenta tu proyecto!' },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ScrapYard Bogotá es una Hackathon para estudiantes de bachillerato
              que va a ser realizada en Bogotá, donde podrás crear las ideas
              más estupidas que se te ocurran. Desde una{' '}
              <Link href="https://www.youtube.com/watch?v=PnK4gzO6S3Q">
                lamp that flashes faster the slower you type
                lampara que parpadea más rápido entre más lento escribes
              </Link>
              , hasta esas ideas que pensarías que no sirven
              goes at Scrapyard. No matter your experience, Scrapyard
              pueden participar en esta Hackathon. No importa tu nivel de experiencia
              Bogotá te necesita a ti y a tus descabelladas ideas.
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          >
            ¿Qué está pasando en ScrapYard Bogotá?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ScrapYard Bogotá es un evento de 12 horas - Acá está el horario estimado
        </Heading>
        <Box
          sx={{
            display: 'flex',
      ...
      >
        ...
        >
          ¡Hay más de 100 eventos de ScrapYard alrededor del mundo!
        </Heading>
        <Box
          sx={{
            width: ['100%', '80%'],
      ...
      >
        ...
        >
          {Object.entries({
            '¿Quién puede participar': (
              <>
                ¡Cualquier adolescente de entre 13 y 18 años está bienvenido! No tienes que ser miembro de Hack Club.
              </>
            ),
            '¿¡Todo esto es gratis!?': (
              <>
                Sí! Comida, stickers y un ambiente amigable están incluidos. Además, si vives lejos,{' '}
                <Link href="https://gas.hackclub.com/">
                  cubriremos el costo de la gasolina o del tiquete de bus.
                </Link>
                .
              </>
            ),
            '¿Qué necesito llevar?': (
              <>
                ¡Tu portatil, cargadores y una mente abierta! Si estás pensando en crear un proyecto de hardware, no se te olvide llevar todas las herramientas que necesites.
              </>
            ),
            '¿Puedo participar si no soy bueno programando?': (
              <>
                ¡Esta hackathon es para adolescentes con cualquier nivel de programación! Habrán talleres y otros eventos, así que participa y aprende con nosotros. 
                Si quieres ver algunos proyectos para principiantes, échale un ojo a Hack Club Worshops.
              </>
            ),
            '¿Qué puedo desarrollar en ScrapYard Bogotá?': (
              <>
                La idea más loca que tengas – ninguna idea sobra.
                ¿Videojuegos? ¿Aplicaciones? ¿Sitios web? ¿Lenguajes de programación? <em>¿Hardware?</em>{' '}
                ¡Tú lo decides! Tendremos bastante información y mentores que te podrán ayudar.
              </>
            ),
            '¿Qué ha hecho Hack Club antes?': (
              <>
                Hack Club ha realizado una{' '}
                <Link href="https://youtu.be/PnK4gzO6S3Q" target="_blank">
                  hackathon toda la noche
                </Link>{' '}
                en San Francisco, una{' '}
                <Link
                ...
                en 50 ciudades, una hackathon en un{' '}
                <Link href="https://youtu.be/2BID8_pGuqA" target="_blank">
                  Tren
                </Link>{' '}
                desde Vermont hasta Los Angeles, ¡y mucho más!
              </>
            ),
            'Mis papás están preocupados, ¿qué hago?': (
              <>
                Estamos para ayudarte. Nuestra guía para papás será publicada pronto, y si
                tienes alguna pregunta, no dudes en escribirnos a{' '}
            ...
            'Tengo más preguntas': (
              <>
                ¡Contáctanos! Puedes enviarnos un mensaje en el canal de{' '}
                <Link href="https://hackclub.slack.com/archives/C086U9GBQRM">
                  #scrapyard-bogota
                </Link>{' '}
                en Slack, o puedes mandarnos un correo a{' '}
                <Link href="mailto:bogota.scrapyard@hackclub.com">
                  bogota.scrapyard@hackclub.com
                </Link>
                .
        ...
        >
          ...
          >
            ...
            >
              Inscríbete para participar en ScrapYard Bogotá
            </Heading>
          </Box>
        </Link>
        <Heading
